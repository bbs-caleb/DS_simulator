"""CPC sampling and simulated A/B testing."""
...
def ab_test(
    ...
    ----------
    n_simulations:
        Number of simulated A/B experiments.
    n_samples:
        Number of CPC observations in each group.
    conversion_rate:
        Conversion rate in the control group.
    mde:
        Relative conversion-rate increase in the test group.
    reward_avg:
    ...
    -------
    float
        Share of simulations where the real effect was not detected.
    """
